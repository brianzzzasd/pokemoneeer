              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="pokemon in pokemons" :key="pokemon.email">
                  ...
                  <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-left text-sm font-medium sm:pr-6">
                    <div class="flex">
                      <div class="mr-4 cursor-pointer" @click="hate(pokemon.id)">
                      ...
                      <div class="mr-4 cursor-pointer" @click="like(pokemon.id)">
                      ...
                      <div class="mr-4 cursor-pointer" @click="favorite(pokemon.id)">
