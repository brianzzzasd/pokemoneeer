              ...
              <tbody class="divide-y divide-gray-200 bg-white">
                <tr v-for="pokemon in pokemons" :key="pokemon.email">
                  ...
                  <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-left text-sm font-medium sm:pr-6">
                    <div class="flex">
                      <div class="mr-4 cursor-pointer" @click="addHate(pokemon.id)">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8 hate-icon">
                      ...
                      <div class="mr-4 cursor-pointer" @click="addLike(pokemon.id)">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="skyblue" class="w-8 h-8 like-icon">
                      ...
                      <div class="mr-4 cursor-pointer" @click="addFavorite(pokemon.id)">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="yellow" class="w-8 h-8 favorite-icon">
